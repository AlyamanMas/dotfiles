...

{
  ...
  environment.systemPackages = ( with pkgs; [
    ...
    tealdeer                                  # Docs/Help
    firefox elinks chromium                   # Web browsers
    exa fd                                    # Rust cli utils
    xterm alacritty                           # Terminal emulators
    pavucontrol
    ...
    rclone
    fuzzel wofi                               # Menues
    pamixer brightnessctl                     # Hardware clis
    sway-contrib.grimshot
    gnome.nautilus cinnamon.nemo dolphin      # Graphical file managers
    mpd mpc_cli ncmpcpp                       # Music
    mako waybar                               # Ricing necessities
    ...
    imv sxiv                                  # Image Viewers
    # jetbrains.pycharm-community
    tdesktop                                  # Telegram desktop
    lxappearance tela-icon-theme              # Theming
    gtk-engine-murrine gtk_engines gsettings-desktop-schemas
    python3 pipenv                            # Python + utils
    html-tidy ktlint nixfmt shellcheck        # Code checkers/formatters...
    openjdk
    killall
    ...
    konsole
    ark
    ffmpeg-full ffmpegthumbnailer ffmpegthumbs
    filelight
    wl-clipboard grim xmlformat
    ncdu duf
