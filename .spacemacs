...
This function should only modify configuration layer settings."
  (setq-default
   ...
   dotspacemacs-additional-packages '(rainbow-mode cdlatex graphviz-dot-mode gruvbox-theme)
...
before packages are loaded."
  ...
  (setq mu4e-contexts
        (list
         (make-mu4e-context
          :name "work" ;;for alyamanmaasarani-gmail
          ...
          :vars '((user-mail-address . "alyamanmaasarani@gmail.com")
	                ...
	                (mu4e-compose-format-flowed . t)
	                (smtpmail-queue-dir . "~/Maildir/alyamanmaasarani-gmail/queue/cur")
	                (message-send-mail-function . smtpmail-send-it)
	                (smtpmail-smtp-user . "alyamanmaasarani")
	                ...
	                (mu4e-maildir-shortcuts . ( ("/alyamanmaasarani-gmail/INBOX"            . ?i)
					                                    ("/alyamanmaasarani-gmail/[alyamanmaasarani].Sent Mail" . ?s)
					                                    ("/alyamanmaasarani-gmail/[alyamanmaasarani].Bin"       . ?t)
  ...
  ;; (add-hook 'prog-mode-hook '(set-variable display-line-numbers 'relative))
  )
